...
{
    public abstract class VrsDevice : BaseARDevice
    {
        ...
        protected void ConnectToActivity() {
        try {
        ...
        public override void UpdateState()
        {
            ...
            if (VrsViewer.Instance.LockHeadTracker || (headData[0] == 0 && headData[15] == 0))
            {
        ...
        public bool GetProjectionScreenStatus()
        {
            return _NVR_GetParamI((int)PARAMS_KEY.UNITY_PARAMS_KEY_WFD_STATUS) == 1;
        }

        public void GetWfdScreenSize(int[] screenSize)
        {
